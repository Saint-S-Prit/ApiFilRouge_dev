...
class User implements UserInterface
{
     ...
     * @Assert\NotBlank(message="the Email must be empty")
     * 
     */
    private $email;
     ...
     * @Assert\NotBlank(message="the libelle password be empty")
     */
    private $password;
     ...
     * @ORM\Column(type="string", length=255)
     * @Groups({"user_read","learner_read","teacher_read"})
     * @Assert\NotBlank(message="the adresse must be empty")
     */
    private $adresse;
     ...
     * @ORM\Column(type="string", length=255)
     * @Groups({"user_read","learner_read","teacher_read"})
     * @Assert\NotBlank(message="the phone must be empty")
     */
    private $phone;
     ...
     * @ORM\Column(type="string", length=255)
     * @Groups({"user_read","learner_read","teacher_read"})
     * @Assert\Choice(choices={"male","female"}, message={"the genre must be MALE or FEMALE "})
     */
    private $gender;
